...
public:
    CMainParams()
    {
        ...
        nCollateralMaturity = 1000;                 // 3 month locking period after nCollateralMaturityEnforcementHeight is reached
        nCollateralMaturityEnforcementHeight = 50; // Starting at block 50 to give time to setup nodes
